...
var MMMainLayer = cc.Layer.extend({
    ...
    loadMenu : function(){
        // 开始冒险
        var startNormal    = new cc.Sprite("res/MainMenu/" + GC.i18n + "/front_btn_start_normal.png");
        var startSelected  = new cc.Sprite("res/MainMenu/" + GC.i18n + "/front_btn_start_pressed.png");
        var startDisabled  = new cc.Sprite("res/MainMenu/" + GC.i18n + "/front_btn_start_normal.png");
        ...
        // 天天向上
        var floorNormal    = new cc.Sprite("res/MainMenu/" + GC.i18n + "/front_btn_floor_normal.png");
        var floorSelected  = new cc.Sprite("res/MainMenu/" + GC.i18n + "/front_btn_floor_pressed.png");
        var floorDisabled  = new cc.Sprite("res/MainMenu/" + GC.i18n + "/front_btn_floor_normal.png");
